...
const AboutMe = () => {
  ...
  return (
    <div className="container font-Inconsolata mx-auto max-w-[95%] ">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-[30%]" viewBox="0 0 200 200" width="200" height="200"  preserveAspectRatio="xMidYMid meet">
            <defs>
      ...
      <div>
      <h1 className="font-extrabold text-3xl leading-loose">Hi, I&apos;m Tomi Bello</h1>
        <p>A Software Engineer</p>
        <p>
                I specialize in building exceptional digital products for businesses and founders. My expertise lies in JavaScript, TypeScript, React, and Node.js, allowing me to create robust and scalable applications. I am passionate about leveraging technology to solve real-world problems and enhance the way we interact with the digital landscape. 
        </p>
