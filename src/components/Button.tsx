...
export const Button = (props: {
    ...
    return (
      ...
      <svg 
        ...
        <motion.button  className={twMerge("text-xs text- z-10 w-fit h-11 px-4 inline-flex justify-center items-center gap-4 text-center  transition duration-500 relative group/button ", 
